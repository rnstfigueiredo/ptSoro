...
# conDb = DBI::dbConnect(RMariaDB::MariaDB(), user='denise', password='T7p2m3@Cievs13',
#                      dbname='cevesp_2k17', host='192.168.1.204')
...
app_server <- function(input, output, session) {
  ...
  # conDb = DBI::dbConnect(RMariaDB::MariaDB(),
  #                        user='rnst',            # usuário
  #                        password='awtazbt',  # senha
  #                        dbname='dados',           # base de dados
  #                        host=localhost)
